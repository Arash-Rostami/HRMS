@foreach($posts as $post)
    <div class="w-1/2 text-center h-auto mt-1 p-1">
        <div class="card-link rounded links-thumbnails links-thumbnails-color h-full
             p-0 min-h-[470px] md:min-h-[450px] flex flex-col justify-between bg-weekend">
            <div>
                <img class="mx-auto max-h-44 w-auto"
                     src="{{$post->image}}"
                     alt="post">
                {{-- post --}}
                <div class="p-4 pt-2">
