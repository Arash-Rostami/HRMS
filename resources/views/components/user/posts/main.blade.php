<div
    ...
    <div
        id="flush-collapseBulletin"
        aria-labelledby="flush-headingBulletin"
        x-show="open"
        x-collapse
        @class([
