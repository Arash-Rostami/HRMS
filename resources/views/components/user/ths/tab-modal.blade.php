@if($selectedTicket)
    <div x-data="{ isClosing: false}"
         x-cloak
         :class="{ 'animate-[fade-in-down_1s_ease-in-out]': !isClosing, 'animate-[fade-out_1s_ease-in-out]': isClosing }"
        ...
        <div class="rounded-lg w-full max-w-4xl p-6 lg:p-8 shadow-full">
            <div class="flex justify-between items-center mb-4 ltr-direction">
                <h3 class="font-bold text-main-mode cursor-help" title="Ticket Number">
                    🎫
