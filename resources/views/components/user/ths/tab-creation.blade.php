                        ...
                        <div class="flex items-center w-full">
                            <label for="dropzone-file-{{ $key }}"
                              ...
                              cursor-pointer bg-gray-100 hover:bg-gray-200 dark:border-gray-600">
                                ...
                                <p x-show="!isUploaded" class="text-gray-500 px-4">
                                    <span class="font-semibold">فایل ضمیمه</span>
                                </p>
                                <p x-show="!isUploaded" class="hidden md:inline text-gray-500 px-4">
                                    PDF, PNG, JPG (MAX 4MB)
                                </p>
                                <div x-show="isUploaded" title="بارگزاری موفقیت آمیز">✔️</div>
