@if ($links->filter(fn($link) => $link['link'] === 'external')->isNotEmpty())
    <div
        ...
        <div
            id="flush-collapseTools"
            aria-labelledby="flush-headingTools"
            x-show="open"
            x-collapse
            @class([
