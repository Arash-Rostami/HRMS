<div
    ...
    <div
        id="flush-collapseLinks"
        aria-labelledby="flush-headingLinks"
        x-show="open"
        x-collapse
        @class([
