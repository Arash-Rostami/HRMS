<nav>
    <div
        ...
        x-cloak
        x-init="
            backgroundEnabled = JSON.parse(localStorage.getItem('backgroundEnabled')) ?? false;
            $watch('backgroundEnabled', value => localStorage.setItem('backgroundEnabled', JSON.stringify(value)));
            $watch('version', () => handleNavVisibility());
            $watch('presence', () => handleNavVisibility());
        ">
        <!-- Primary Navigation Menu -->
        <div class="mx-2 sm:mx-6 md:mx-10 lg:mx-16 xl:mx-20 fade-in-three" x-cloak>
            <div class="flex items-center h-16">
                ...
                <div class="flex w-full items-center justify-evenly">
                    ...
                    <div @class([
                        ...
                        <!-- Bg Toggle -->
                        <div @click="backgroundEnabled = !backgroundEnabled"
                             class="flex items-center justify-center cursor-pointer group min-w-0 mx-3"
                             :title="backgroundEnabled ? 'غیرفعال کردن پس زمینه' : 'فعال کردن پس زمینه ساعتی'">
                            <i :class="backgroundEnabled ? 'fa-image' : 'fa-ban'"
                                    @class([
                                     'fa text-lg transition-all duration-200 transform group-hover:scale-110 flex-shrink-0',
                                     'text-gray-400 group-hover:text-teal-400' => isDarkMode(),
                                     'text-gray-600 group-hover:text-teal-500' => !isDarkMode(),
                                    ])></i>
                        </div>

                        <!-- Presence Toggle -->
                        <div class="flex items-center justify-center cursor-pointer group min-w-0">
                            <i @class([
                        ...
                        <!-- Version Toggle -->
                        <div class="flex items-center justify-center cursor-pointer group min-w-0 ml-auto mr-3">
                            <i @class([
