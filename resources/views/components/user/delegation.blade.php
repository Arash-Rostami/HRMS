<div class="flex flex-col sm:flex-col flex-grow fade-in-fwd p-4 md:p-8 m-4 md:m-8 bg-white border-1 shadow-lg rounded-xl  @if ( isDarkMode()) bg-[#1F2937] @endif main-user-accordion-panel" x-cloak>
    {{--rubric--}}
    <div class="mb-5 w-1/2 md:w-1/4">
        <h2
            ...
            title="This is the place to identify managers' authorities."
{{--            onclick="(this.classList.contains('before:content-[\'+\']')) ? this.classList.toggle('before:content-[\'+\']')--}}
{{--            : this.classList.add('before:content-[\'+\']'); "--}}
            data-te-collapse-init
            data-te-target="#flush-collapseDelegation"
            type="button"
            data-te-toggle="collapse"
            data-bs-target="#flush-collapseDelegation"
            aria-expanded="false" aria-controls="flush-collapseDelegation">
    ...
    <div id="flush-collapseDelegation"
        ...
        <x-user.responsibilities :delegations="$delegations"/>
    </div>
</div>
