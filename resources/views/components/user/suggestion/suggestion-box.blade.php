<div
    ...
    class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[999] persol-farsi-font"
    @click="suggestionBox = false">
    <div class="fixed top-14 w-full md:w-2/3 my-auto mx-auto max-h-[100vh] overflow-y-auto rounded-lg animate-[fade-in-down_500ms_ease-in-out]"
         x-show="suggestionBox"
        ...
        <div class="w-full h-11 rounded-t-lg bg-gray-200 @if(isDarkMode()) bg-main @endif flex items-center">
            ...
            <span class="mr-auto ml-4 text-gray-500 cursor-pointer" @click="suggestionBox = false">
            ...
            <div
                ...
                <div class="flex flex-row flex-wrap">
                    <template x-for="rule in selectedRecord.rule">
                        <div
                            class="bg-gray-200 @if(isDarkMode()) bg-main @endif text-gray-500 px-4 py-1 my-2 mx-4 rounded"
                ...
                <div class="flex flex-row flex-wrap">
                    ...
                    <template x-for="department in JSON.parse(selectedRecord.department)">
                        <div
                            class="bg-gray-200 @if(isDarkMode()) bg-main @endif px-4 py-1 my-2 mx-4 rounded text-amber-500"
