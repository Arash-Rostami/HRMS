<div
    ...
    <div
        id="flush-collapseCalendar"
        aria-labelledby="flush-headingCalendar"
        x-show="open"
        x-collapse
        @class([
