<div x-data="{
    ...
    <div class="mx-auto p-4 rtl-direction persol-farsi-font">
        {{-- Legend --}}
        <div class="mb-4 flex space-x-4 items-center float-left">
            <div class="flex items-center">
                ...
                <span class="ml-2 text-red-500"> امضا نشده</span>
            </div>
            <div class="flex items-center">
                <span class="w-4 h-4 bg-gray-500 inline-block rounded-full mx-2"></span>
                <span class="ml-2 text-gray-500"> خوانده نشده</span>
            </div>
        </div>
        {{-- Search Box --}}
        <div class="mb-4">
            <label>
                <input type="text"
                    ...
                    @class([
                          'w-full md:w-1/2 lg:w-1/3 px-4 py-2 border rounded-lg shadow-sm transition-all duration-300 ease-in-out bg-gray-300',
                          'bg-gray-800 text-primary-50' => isDarkMode()
                      ])>
            </label>
            <button
                @click="searchTerm = ''"
            ...
            <div class="flex space-x-2 flex-row flex-wrap">
                @foreach ($types as $type)
                    <button
                        type="button"
                        @click="searchTerm='{{$type}}'"
                        @class([
                            'px-4 py-2 bg-gray-300 rounded hover:bg-gray-500 mt-6 mx-2',
            ...
            <table class="min-w-full bg-[--bg-main] rounded-xl main-color">
                ...
                <tr class="rounded-xl">
                    <th class="text-center py-3 px-4 font-semibold">
                        <i class="fas fa-file-alt ml-1"></i><br>عنوان سند
                    </th>
                    <th class="text-center py-3 px-4 font-semibold">
                        <i class="fas fa-code-branch ml-1"></i><br>نسخه
                    </th>
                    <th class="text-center py-3 px-4 font-semibold">
                        <i class="fas fa-file-download ml-1"></i><br>فایل
                    </th>
                    <th class="text-right py-3 px-4 font-semibold max-w-xs">
                        <i class="fas fa-users ml-1"></i><br>واحد (های) ذی نفع
                    </th>
                    <th class="text-center py-3 px-4 font-semibold">
                        <i class="fas fa-info-circle ml-1"></i><br>وضعیت
                    </th>
                    <th class="text-center py-3 px-4 font-semibold">
                        <i class="fas fa-comment-dots ml-1"></i><br>توضیحات
                    </th>
                    <th class="text-center py-3 px-4 font-semibold">
                        <i class="fas fa-eye ml-1"></i><br>تعداد دفعات مشاهده
                    </th>
                </tr>
                </thead>
                    ...
                    @if($doc)
                        <tr
                            ...
                            <td class="text-right py-2 px-4">
                                <span class="text-main" title="Filter based on this Category keyword">
