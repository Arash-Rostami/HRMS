    ...
    <div class="mb-4 md:w-1/5">
        ...
        <div class="flex">
            ...
            <select wire:model="birthYear" id="birthYear" required
                    class="shadow appearance-none border rounded ml-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-8 w-full text-sm pl-2">
            ...
            <select wire:model="birthMonth" id="birthMonth" required
                    class="shadow appearance-none border rounded ml-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-8 w-full text-sm text-center">
