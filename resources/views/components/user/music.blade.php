<div class="flex flex-col sm:flex-col flex-grow fade-in-fwd p-4 md:p-8 m-4 md:m-8 bg-white border-1 shadow-lg rounded-xl @if ( isDarkMode()) bg-[#1F2937] @endif main-user-accordion-panel"
    ...
    <div class="mb-5 w-1/2 md:w-1/4">
        <h2
            ...
            title="This is the place to play some beats for workout in the office hours."
            data-te-collapse-init
            data-te-target="#flush-collapseWorkOut"
            type="button" data-te-toggle="collapse" data-bs-target="#flush-collapseWorkOut"
            aria-expanded="false" aria-controls="flush-collapseWorkOut">
    ...
    <div id="flush-collapseWorkOut"
         ...
         aria-labelledby="flush-headingWorkOut" data-te-parent="#accordionFlushExample">
        <x-user.tunes></x-user.tunes>
        <!-- Background Shapes -->
        <x-user.bg-shapes/>
    </div>
</div>
